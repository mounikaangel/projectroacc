...
var point2 = move(point1, { x : 4, y : -2 }); // Move 4 across and 2 down

showPoint(point1); // ( 2 , 5 )
console.log("Move 4 across and 2 down");
showPoint(point2); // ( 6 , 3 )
var point3 = move(point1, { x : -3, y : 7 }); // Move -3 across and 7 up
showPoint(point3); // ( -1 , 12 )
